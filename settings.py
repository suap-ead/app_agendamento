...
from suapintegration.default_settings import *

DEBUG = env_as_bool("DJANGO_DEBUG", False)

# Apps
MY_APPS = env_as_list('MY_APPS', 'agendamento')
THIRD_APPS = env_as_list('THIRD_APPS', 'tabbed_admin,markdownx,import_export')
...
INSTALLED_APPS = MY_APPS + SUAPINTEGRATION_APPS + THIRD_APPS + DJANGO_APPS
...
URL_PATH_PREFIX = env('URL_PATH_PREFIX', '/sead/agendamento/')
...
DATABASES = {
    'default': {
        ...
        'NAME': env('POSTGRES_DB', 'sead_agendamento'),
        'USER': env('POSTGRES_USER', 'sead_user'),
        'PASSWORD': env('POSTGRES_PASSWORD', 'sead_pass'),
    }
}
...
# UI
ADMIN_SITE_URL = env('DJANGO_ADMIN_SITE_URL', URL_PATH_PREFIX)
ADMIN_SITE_TITLE = env('DJANGO_ADMIN_SITE_TITLE', "Admin")
ADMIN_SITE_HEADER = env('DJANGO_ADMIN_SITE_HEADER', "Admin")
