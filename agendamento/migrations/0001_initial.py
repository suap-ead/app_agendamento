...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, to='agendamento.Diretoria', verbose_name='Restrito às diretorias'),
        ),
        migrations.AddField(
            model_name='agenda',
            name='restrito_aas_turmas',
            field=models.ManyToManyField(blank=True, to='agendamento.Turma', verbose_name='Restrito às turmas'),
        ),
        migrations.AddField(
            model_name='agenda',
            name='restrito_aos_campi',
            field=models.ManyToManyField(blank=True, to='agendamento.Campus', verbose_name='Restrito aos campi'),
        ),
        migrations.AddField(
            model_name='agenda',
            name='restrito_aos_cursos',
            field=models.ManyToManyField(blank=True, to='agendamento.Curso', verbose_name='Restrito aos cursos'),
        ),
    ]
